...
//            Glide.with(context).load(followItem.src3).into(binding.ivPhoto3)
            ...
            constrainSet.setVerticalBias(R.id.iv_photo1, Random().nextFloat())
            constrainSet.setVerticalBias(R.id.iv_photo2, Random().nextFloat())
            constrainSet.setVerticalBias(R.id.iv_photo3, Random().nextFloat())
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.binding.root.setOnClickListener{
            ...
            appCompatActivity.supportFragmentManager.beginTransaction().add(R.id.container_bnv, MyBioFragment()).addToBackStack(null).commit()
        }
    }
